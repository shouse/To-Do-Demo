...
// in simulator we redefine to format for To_Do Developer console
...
{\
	NSString * exceptionName = [@"org.to_do." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.to_do";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UITo_DoNativeItemNone = -1, 
	UITo_DoNativeItemSpinner = -2,
	UITo_DoNativeItemProgressBar = -3,
	
	UITo_DoNativeItemSlider = -4,
	UITo_DoNativeItemSwitch = -5,
	UITo_DoNativeItemMultiButton = -6,
	UITo_DoNativeItemSegmented = -7,
	
	UITo_DoNativeItemTextView = -8,
	UITo_DoNativeItemTextField = -9,
	UITo_DoNativeItemSearchBar = -10,
	
	UITo_DoNativeItemPicker = -11,
	UITo_DoNativeItemDatePicker = -12,
	
	UITo_DoNativeItemInfoLight = -13,
	UITo_DoNativeItemInfoDark = -14,
	
	UITo_DoNativeItemDisclosure = -15,
	
	UITo_DoNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all To_Do instances of
