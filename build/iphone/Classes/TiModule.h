...
/**
 The base class for all To_Do modules
 */
...
/**
 To_Do Platform calls this method on startup.
 */
-(void)startup;

/**
 To_Do Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 To_Do Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 To_Do Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 To_Do Platform calls this method on resume.
 @param sender The sender of the event.
 */
